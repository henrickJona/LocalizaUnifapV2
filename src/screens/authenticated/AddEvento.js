...
var currentDate = new Date()
 function AddEvento({navigation:{goBack}}) {
...
getMyEvents()
setLoading(false)
Toast.show('Evento Cadastrado!!', Toast.SHORT, ['UIAlertController']);
goBack()
...
<View style={estilo.principal}>
  ...
  {/* {showDataInicio?( <DateTimePicker
          ...
          />):null} */}
              ...
              <TouchableOpacity style={estilo.botao} onPress={()=>cadastrarEvento()} >
                <Text style={estilo.botaoTexto}>Cadastrar Evento</Text>
              </TouchableOpacity>
